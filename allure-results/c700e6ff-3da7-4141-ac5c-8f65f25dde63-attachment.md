  ...
  - generic [ref=e2]:
    ...
    - contentinfo [ref=e164]:
      - generic [ref=e165]:
        - generic [ref=e166]:
          - img [ref=e167]
          - paragraph [ref=e170]: 11:54:24 AM
        - generic [ref=e171]:
          - img [ref=e172]
          - paragraph [ref=e175]: 11%
        - generic [ref=e176]:
          - img [ref=e177]
          - paragraph [ref=e179]: 13%
        - img [ref=e180]
        - 'generic "Текущая версия ПК: 1.99.999" [ref=e184]':
          - paragraph [ref=e185]: 1.99.999
  - region "bottom-end Notifications alt+T"
  - menu "Роутер" [active] [ref=e187]:
    - menuitem "Отправить конфигурацию" [ref=e188]
    - menuitem "Получить конфигурацию" [ref=e189]
    - menuitem "Запустить сервер" [ref=e190]
    - menuitem "Остановить сервер" [ref=e191]
    - menuitem "Перезапустить сервер" [ref=e192]
```