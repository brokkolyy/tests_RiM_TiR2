  ...
  - generic [ref=e2]:
    ...
    - contentinfo [ref=e164]:
      - generic [ref=e165]:
        - generic [ref=e166]:
          - img [ref=e167]
          - paragraph [ref=e170]: 12:32:42 PM
        - generic [ref=e171]:
          - img [ref=e172]
          - paragraph [ref=e175]: 27%
        - generic [ref=e176]:
          - img [ref=e177]
          - paragraph [ref=e179]: 32%
        - img [ref=e180]
        - 'generic "Текущая версия ПК: 1.99.999" [ref=e184]':
          - paragraph [ref=e185]: 1.99.999
  - region "bottom-end Notifications alt+T":
    - status "Произошла ошибка" [ref=e186]:
      - img [ref=e187]
      - generic [ref=e189]:
        - generic [ref=e190]: Произошла ошибка
        - generic [ref=e191]: Network Error
  - menu "Роутер" [active] [ref=e194]:
    - menuitem "Отправить конфигурацию" [ref=e195]
    - menuitem "Получить конфигурацию" [ref=e196]
    - menuitem "Запустить сервер" [ref=e197]
    - menuitem "Остановить сервер" [ref=e198]
    - menuitem "Перезапустить сервер" [ref=e199]
```