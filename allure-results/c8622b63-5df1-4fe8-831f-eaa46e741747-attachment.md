    ...
    - contentinfo [ref=e169]:
      - generic [ref=e170]:
        ...
        - generic [ref=e181]:
          ...
          - paragraph [ref=e184]: "----"
        - img [ref=e185]
        - 'generic "Текущая версия ПК: 1.99.999" [ref=e189]':
          - paragraph [ref=e190]: 1.99.999
  - region "bottom-end Notifications alt+T"
  - menu [active] [ref=e192]:
    - menuitem "Создать папку" [ref=e193]:
      - img [ref=e194]
      - text: Создать папку
    - menuitem "Создать переменную" [ref=e196]:
      - img [ref=e197]
      - text: Создать переменную
      - img [ref=e202]
    - menuitem "Вставить Ctrl+V" [disabled] [ref=e204]:
      - img [ref=e205]
      - text: Вставить
      - generic [ref=e209]: Ctrl+V
```