...
- generic [ref=e1]:
  ...
  - generic:
    - alertdialog "Похоже, что конфигурация отсутствует":
      - generic:
        - heading "Похоже, что конфигурация отсутствует" [level=2]
      - generic:
        - paragraph
        - paragraph:
          - text: Для работы с конфигурацией вы можете
          - mark: загрузить
          - text: её с вашего устройства, выполнить
          - mark: синхронизирацию
          - text: с сервером или
          - mark: создать
          - text: новую.
      - generic:
