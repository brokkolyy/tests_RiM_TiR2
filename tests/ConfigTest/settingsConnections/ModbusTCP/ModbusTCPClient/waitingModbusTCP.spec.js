...
test('Активация функции логирования', async ({ page }) => {
    ...
    const clickLog = page.locator('[id="switch::r1k::thumb"]');
    await clickLog.click();
    const colorLog = page.locator('[id="switch::r1k::control"]');
...
test('Отключение функции логирования', async ({ page }) => {
    ...
    await expect(colorLog).toBeVisible();   ;                                  // await page.locator('[id="switch::r1k::thumb"]').click();await page.locator('[id="switch::r1k::control"]').click();await page.locator('span').nth(5).click();
});