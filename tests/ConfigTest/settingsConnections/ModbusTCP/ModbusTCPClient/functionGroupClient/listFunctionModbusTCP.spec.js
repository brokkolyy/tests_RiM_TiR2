...
test.describe('Навигация', () => {
    test.beforeEach(async ({page}) => {
        ...
        await page.locator('div').filter({ hasText: /^MB TCP127\.0\.0\.1502modbusTCP_client$/ }).nth(1).click({button:'right'});
...
test('(0x02) Чтение значений из нескольких дискретных входов', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:2"]')).toBeVisible();
});
...
test('(0x03) Чтение значений из нескольких регистров хранения', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:3"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x04) Чтение значений из нескольких регистров ввода', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:4"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x05) Запись значения одного флага', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:5"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x06) Запись значения в один регистр хранения', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:6"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x15) Запись значений в несколько регистров флагов', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:15"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x16) Запись значений в несколько регистров хранения', async ({ page }) => {
    ...
    //await item.click();
    //await expect(page.locator('[id="select::r1r::option:16"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
});