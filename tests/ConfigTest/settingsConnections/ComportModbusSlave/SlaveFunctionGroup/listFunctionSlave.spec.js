...
test.describe('Навигация', () => {
    test.beforeEach(async ({page}) => {
        ...
        const el = page.getByText('functionGroup');
...
test('(0x01) Чтение значений из нескольких регистров флагов', async ({ page }) => {
    ...
    await op1.click();
    await expect(page.getByRole('listbox', { name: 'Функция' })).toBeHidden();
...
test('(0x02) Чтение значений из нескольких дискретных входов', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:2"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x03) Чтение значений из нескольких регистров хранения', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:3"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x04) Чтение значений из нескольких регистров ввода', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:4"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x05) Запись значения одного флага', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:5"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x06) Запись значения в один регистр хранения', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:6"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x15) Запись значений в несколько регистров флагов', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:15"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
...
test('(0x16) Запись значений в несколько регистров хранения', async ({ page }) => {
    ...
    await item.click();
    await expect(page.locator('[id="select::r18::option:16"] > .chakra-select__itemIndicator > .css-s3mb0o')).toBeVisible();
});
});